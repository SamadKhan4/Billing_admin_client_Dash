...
const AllVendors = () => {
  ...
  const fetchCustomers = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/users/vendors`, {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <UserTypeDropdown current="Vendors" />
      <h1 className="text-2xl font-bold mb-6 text-yellow-600">All Vendors</h1>
            ...
            <tr key={user._id} className="hover:bg-yellow-50">
              ...
              <td className="border px-4 py-2 flex justify-center items-center gap-4">
                ...
                <button
                  ...
                  className={`text-red-600 hover:text-red-800 transition-transform transform hover:scale-110 ${deletingId === user._id ? "opacity-50 cursor-not-allowed" : ""
                    }`}
                >
                  <Trash2 size={22} />
                </button>
